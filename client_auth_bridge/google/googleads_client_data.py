...
from .google_service_handler import google_bp
from sqlalchemy.dialects.postgresql import insert

googleads_bp = Blueprint('googleads', __name__)

#@google_bp.route("/googleads/clientdata", methods=['POST'])
