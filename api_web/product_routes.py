...
def get_products():
    ...
    columns = ['product_name','image_url','impressions', 'clicks', 'add_to_cart','spend', 'revenue', 'units', 'roas','cpc', 'cr_percent', 'c2c_percent']
...
def get_catalogue_products():
    ...
    columns = ['product_name','image_url','clicks', 'add_to_cart','spend', 'revenue', 'units', 'roas','cpc', 'cr_percent', 'c2c_percent']
    result = [dict(zip(columns, row)) for row in data]
