...
mongo_collection = mongo_db["fingerprint"]
...
for mongo_doc in result:
    ...
    postgres_cursor.execute(
        "INSERT INTO visitor_info (visitorid, _session, productid, event_time) VALUES (%s, %s, %s, %s)",
        (mongo_doc['vistorid'], mongo_doc['session'], str(int(mongo_doc['productid'])),creation_at ),
    )
